...
<div class="services-switcher my-5">
    <button class="services-switcher-button pe-5 active position-relative header-m-600">Для частных лиц
    </button>
    <button class="services-switcher-button header-m-600">Для бизнеса</button>
</div>
