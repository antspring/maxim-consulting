...
<section class="service-container">
    <div class="main-heading">
        <div class="heading-container">
            <h1 class="bold-item heading">Банкротство физических лиц</h1>
            <p class="sub-heading">
...
<div class="main-container">
    <section class="services-questions">
        <h2 class="bold-item heading">Как помогаем</h2>
        <ul class="list-group">
        ...
        <h2 class="bold-item heading">Как работаем</h2>
        <ul class="list-group">
            <li class="list-item position-relative">
        ...
        <h2 class="bold-item heading">Кому подойдет процедура банкротства физического лица</h2>
        <p>
        ...
        <h3 class="service-sub-heading semi-bold-item">Через суд</h3>
        <ul class="list-group">
            <li class="list-item position-relative">
        ...
        <h3 class="service-sub-heading semi-bold-item">Через МФЦ</h3>
        ...
        <h3 class="service-sub-heading semi-bold-item">Сколько длится процедура</h3>
        <p>
        ...
        <h3 class="service-sub-heading semi-bold-item">Какие будут последствия</h3>
        ...
        <h3 class="service-sub-heading semi-bold-item">Стоимость банкротства физического лица</h3>
        <p>
